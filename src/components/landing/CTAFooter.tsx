// Seção 10: CTA Final + Footer — fundo navy
// Server Component
const WA_LINK =
...
export default function CTAFooter() {
  return (
    <>
      ...
      <section className="py-16 sm:py-24" style={{ backgroundColor: "#1E2A3A" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            className="btn-cta-landing inline-flex items-center justify-center gap-3 text-white font-bold text-sm sm:text-lg px-6 sm:px-10 py-4 sm:py-5 rounded-full shadow-2xl w-full sm:w-auto"
          >
            <IconeWhatsApp />
      ...
      {/* Footer — pb-20 no mobile para não sobrepor o WhatsApp float */}
      <footer
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 text-gray-400">
              ...
              <a
                href="mailto:suporte@cibrido.com.br"
                className="hover:text-white transition-colors"
              >
                suporte@cibrido.com.br
              </a>
            </div>
          </div>
        </div>
